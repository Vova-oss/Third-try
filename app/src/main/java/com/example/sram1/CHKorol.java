...
public class CHKorol extends Figyra {
    ...
    public void moov() {
        ...
        if (tappedY<7&&tappedX>0&&sides[tappedY+1][tappedX-1]==1) {//враг слева, внизу
            cells[tappedY+1][tappedX-1].setBackgroundColor(Color.parseColor("#FF0000"));
            gertva [tappedY+1][tappedX-1]=true;//код жертвы
        }

        if (tappedX > 0 && sides[tappedY][tappedX - 1]==1) {//враг слева
            cells[tappedY][tappedX-1].setBackgroundColor(Color.parseColor("#FF0000"));
            gertva [tappedY][tappedX-1]=true;//код жертвы
        }

        if (tappedX > 0 && tappedY > 0 && sides[tappedY - 1][tappedX - 1]==1) {//враг слева, вверху
            cells[tappedY-1][tappedX-1].setBackgroundColor(Color.parseColor("#FF0000"));
            gertva [tappedY-1][tappedX-1]=true;//код жертвы
        }

        if (tappedY >0 && sides[tappedY - 1][tappedX]==1) {//враг вверху
            cells[tappedY-1][tappedX].setBackgroundColor(Color.parseColor("#FF0000"));
            gertva [tappedY-1][tappedX]=true;//код жертвы
        }

        if (tappedY>0&&tappedX<7&& sides[tappedY - 1][tappedX+1]==1) {//враг справо, вверху
            cells[tappedY-1][tappedX+1].setBackgroundColor(Color.parseColor("#FF0000"));
            gertva [tappedY-1][tappedX+1]=true;//код жертвы
        }

        if (tappedX<7&& sides[tappedY ][tappedX+1]==1) {//враг справо
            cells[tappedY][tappedX+1].setBackgroundColor(Color.parseColor("#FF0000"));
            gertva [tappedY][tappedX+1]=true;//код жертвы
        }

        if (tappedX<7&& tappedY<7&&sides[tappedY + 1][tappedX+1]==1) {//враг справо, внизу
            cells[tappedY+1][tappedX+1].setBackgroundColor(Color.parseColor("#FF0000"));
            gertva [tappedY+1][tappedX+1]=true;//код жертвы
        }

        if (tappedY < 7 && sides[tappedY + 1][tappedX]==1) {//враг внизу
            cells[tappedY+1][tappedX].setBackgroundColor(Color.parseColor("#FF0000"));
            gertva [tappedY+1][tappedX]=true;//код жертвы
        }
    }
